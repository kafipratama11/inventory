                                    ...
                                    <div class="card">
                                          <div class="card-body">
                                                <div class="mb-2">
                                                      ...
                                                      <button type="button" class="btn border-0 text-light pe-3" data-bs-toggle="modal" data-bs-target="#modalCreateUsage" style="font-size: 14px; background-color: #344C64;">
                                                            New usage
